...
Mouse-is-near is a jQuery plugin which track movement of the cursor and allows you to define events when the cursor is close to some element.  
...
Function 'functionIsFar' is used when we move our cursor further from the element.   
